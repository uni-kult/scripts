...
chmod 600 .ssh/thesis_ed25519
ssh-keygen -f .ssh/thesis_ed25519 -y > .ssh/thesis_ed25519.pub
...
DEBIAN_FRONTEND=noninteractive apt-get install -y perl wget
